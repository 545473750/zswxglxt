...
.iframe_name_box{border:1px solid #666;width:230px;height:29px;line-height:26px;float:left;margin-right:10px;margin-bottom:8px;}
.iframe_name_box p{float:left;padding:0px;margin:0px;text-align:center;}
.iframe_name_box p.iframe_name_text{width:216px;}
...
<input type="hidden" id = "ids" name="orgIds" value="${selectedIds }"/>
<input type="hidden" name="id" value="${id }"/>
<input type="hidden" id = "names" value="${selectedNames }"/>
<div class="llistbox" style="float: left; width:250px; height: 450px; margin-left: 5px;margin-top: 5px;overflow:auto; align:center" >
	<div id="userList" style="padding-left: 2px;">
		<div class='iframe_name_box'><p class='iframe_name_text'><b>已选单位</b></p></div>
		${selectedOrgHTML }
...
<div style="width: 420px; float: left;margin-top:5px;" class="llistbox">
	<iframe src="${ctx}/sys/Partition!findSchool.do" height="450" width="100%"  frameborder="0"  scrolling="auto">
	</iframe>
</div>
