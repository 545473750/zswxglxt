...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(function() {
			...
			/*
			function setSchool(){
				var changeSchoolId=$("#grantOrganizDialog").val();
				parent.dialog({
		...
		<div class="main">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="uiTable">
							...
							<c:forEach items="${page.result}" var="item" varStatus="status">
								<tr class="${status.count % 2 == 0 ? 'jg' : ''}">
									...
									<td width="730">
										<c:forEach items="${item.organizations}" var="org" varStatus="status">
									...
									<td>
										...
										<a
											href="javascript:openDialogById('${ctx}/sys/Partition!selectUnitList.do?id=${item.id}','grantOrganizDialog','grantOrganiz');">分区设置</a>
										<!-- 
										|
										<a
										...
										<a href="javascript:setSchool('${ctx}/sys/Partition!selectUnitList.do?selectUnits=${item.orgIds}','grantOrganizDialog','grantOrganiz');">分区设置</a>
										-->
			...
			<div id="grantOrganizDialog" style="overflow: hidden;">
				<iframe id="grantOrganiz" frameborder="0" marginwidth="0"
					marginheight="0" scrolling="no" width="725" height="555"></iframe>
			</div>
		</div>
	</body>
</html>
