...
<iframe name="leftFrame" width="100%" height="100%" src="${ctx}/sys/Bianzhi!leftTree.do" frameborder="0" scrolling="no" ></iframe>
</div>
</div>
...
<iframe style="padding-left: 0px;" name="rightFrame" width="100%" height="100%" src="${ctx}/sys/Bianzhi!list.do?query.orgId=${orgId}" frameborder="0" scrolling="no"></iframe>
</div>
</div>
