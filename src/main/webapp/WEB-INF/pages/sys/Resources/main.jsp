...
<div class="main-leftit"><img src="${ctx }/images/main_ico18.gif" width="15" height="15" align="absmiddle" /> 菜单管理</div>
<div style="background:#FFF;border:1px solid #bcbcbc; border-top:none;padding-left:12px;padding-bottom:20px;min-height:84%;height:84%;">
 <iframe name="leftFrame" width="100%" height="100%" src="${ctx}/sys/Resources!leftTree.do" frameborder="0" scrolling="auto"></iframe>
</div>
</div>
...
<div class="main-rigtex" style="height : 99%; padding: 0px; padding-top: 0px;">
	<iframe style="padding-left: 0px;" name="mainFrame" width="100%" height="100%" src="${ctx}/sys/Resources!list.do?queryParentId=${queryParentId}" frameborder="0" scrolling="auto"></iframe>
</div>
</div>
