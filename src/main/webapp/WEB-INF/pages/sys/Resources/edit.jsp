...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="${ctx}/scripts/jquery.metadata.js"
			type="text/javascript"></script>
		...
		<script src="${ctx}/scripts/jquery-ui-1.8.9.custom.min.js"
			type="text/javascript"></script>
		<script src="${ctx}/scripts/jquery.blockUI.js"
			type="text/javascript"></script>
		<script src="${ctx}/scripts/My97DatePicker/WdatePicker.js"
			type="text/javascript"></script>
		<script src="${ctx}/scripts/jquery.MultiFile.js"
			type="text/javascript"></script>
...
<body>
		<div class="main">
			...
			<div class="centent" style="padding-top: 10px;">
				<form id="dataform" action="${ctx}/sys/Resources!save.do"
					method="post">
