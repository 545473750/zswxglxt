...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="${ctx}/scripts/jquery.metadata.js" type="text/javascript"></script>
		<script src="${ctx}/scripts/jquery.MultiFile.js" type="text/javascript"></script>
		<script src="${ctx}/scripts/jquery.blockUI.js" type="text/javascript"></script>
	...
	<body>
		<div class="main">
			<div class="maintit">
				<h2><img src="${ctx}/${pattern}/images/tabicon.gif" width="16" height="16" align="absmiddle" />菜单</h2>
				<h3><a href="#" onclick="history.back(-1)">返回 &gt;&gt;</a></h3>
			</div>
			<div class="centent" style="padding-top: 10px;">
				<form id="dataform" action="${ctx}/sys/Resources!save.do" method="post">
					<span> 
		...
		<div id="dialog" style="overflow: hidden;">
			<iframe id="addSit" frameborder="0" marginwidth="0" marginheight="0" scrolling="auto" width="500" height="300"></iframe>
		</div>
	</body>
</html>