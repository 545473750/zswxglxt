...
<div id="header">
  ...
  <div class="nav">
  <a href="#">首  页</a> <a href="#">通知通告</a> <a href="#" class="over">新闻动态</a> <a href="#">教师培训</a> <a href="#">教研科研</a> <a href="#">信息电教</a> <a href="#">继教管理</a> <a href="#">教学教务</a></div>
</div>
<!-- Top end -->
<!-- Conter -->
<div id="content">
  <div class="dqwz">当前位置：<a href="#">首页</a> &gt; <a href="#">新闻动态</a> &gt; 考研新闻</div>
  <div class="list_box">
    <div class="list_tit">
      <div class="lmtit">新闻动态</div>
      <div class="listlm">考研新闻</div>
    </div>
    <div class="list_left">
      <ul>
        <li><a href="#">新闻动态三级栏目</a></li>
        <li><a href="#" class="list_over">考研新闻考研新闻</a></li>
        <li><a href="#">新闻动态三级栏目</a></li>
        <li><a href="#">新闻动态三级栏目</a></li>
        <li><a href="#">新闻动态三级栏目</a></li>
        <li><a href="#">新闻动态三级栏目</a></li>
    ...
    <div class="list_text">
      <ul>
        <li><span>2013-11-28</span><a href="#">2013年朝阳区职业教育教产合作促进中心公开招聘公告</a></li>
        <li><span>2013-11-28</span><a href="#">2013年朝阳区职业教育教产合作促进中心公开招聘公告</a></li>
        <li><span>2013-11-28</span><a href="#">2013年朝阳区职业教育教产合作促进中心公开招聘公告</a></li>
        <li><span>2013-11-28</span><a href="#">2013年朝阳区职业教育教产合作促进中心公开招聘公告</a></li>
        <li><span>2013-11-28</span><a href="#">2013年朝阳区职业教育教产合作促进中心公开招聘公告</a></li>
      ...
      <div class="pages">共135条记录 <a href="#">首页</a> <a href="#">上一页</a> <a href="#">下一页</a> <a href="#">尾页</a> 转到
