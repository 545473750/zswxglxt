...
<!-- Conter -->
<div id="content">
  <div class="dqwz">当前位置：<a href="${ctx}/portal/Xdk!index.do">首页</a> &gt; <a href="${ctx}/portal/Ks!list.do">考试列表</a> &gt;查看详情</div>
  <div class="show_box">
    ...
    <div class="show_bot"><fmt:formatDate value="${model.createTime}" pattern="yyyy-MM-dd"/></div>
  </div>
</div>
<!-- Conter End -->
<div id="footer">
