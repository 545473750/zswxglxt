...
<!-- Conter -->
<div id="content">
  <div class="dqwz">当前位置：<a href="${ctx}/portal/Xdk!index.do">首页</a> &gt; <a href="${ctx}/portal/Dcwj!list.do">调查问卷列表</a> &gt;查看详情</div>
  <div class="show_box">
    <div class="show_tit">${model.spTitle}</div>
    <div class="show_text">
      <%--<p><img src="images/pic.jpg" width="440" height="282" /></p>
      --%><p>${model.description}</p>
    </div>
    <div class="show_bot"><fmt:formatDate value="${model.addtime}" pattern="yyyy-MM-dd"/></div>
  </div>
</div>
<!-- Conter End -->
<div id="footer">
