...
.iframe_name_box{background:url(../images/component/open_textbox.gif) no-repeat left top;width:140px;height:29px;line-height:26px;float:left;margin-right:10px;margin-bottom:8px;}
.iframe_name_box p{float:left;padding:0px;margin:0px;text-align:center;}
.iframe_name_box p.iframe_name_text{width:126px;}
...
<script type="text/javascript">
		...
		function delItem(id, name){
			...
			for(var i = 0; i < nameArray.length; i++) {
				if(nameArray[i] != name) {
					temp.push(nameArray[i]);
				}
			}
			document.getElementById("names").value = temp.join();
			*/
			var names = document.getElementById("names").value;
...
<body>
<div class="op_box_cen" style="width: 100%; overflow: hidden;">
...
<iframe src="${pageContext.request.contextPath }/organiz/User!loadUserList.do" 
	style="border:none;" width="100%" height="200" scrolling="auto">
</iframe>
</div>

<div class="iframe_name" style="overflow: auto; height: 60px;">
