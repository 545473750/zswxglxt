...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="main">
			<div class="maintit">
				<h2>
					<a href="${ctx}/organiz/Organization!toRightPage.do?query.parentId=${query.parentId}" style="text-decoration: none;"> 
					<img src="${ctx}/${pattern}/images/tabicon.gif" width="16" height="16" align="absmiddle" /> 单位信息
					</a>
				</h2>
				<h2 style="background: yellow;"><img src="${ctx}/${pattern}/images/tabicon.gif" width="16" height="16" align="absmiddle" />人员信息</h2>
			...
			<form id="queryForm" name="queryForm" action="${ctx }/organiz/Organization!loadUser.do" method="post" style="display: inline;">
				...
				<tr class="${status.count % 2 == 0 ? 'jg' : ''}">
					...
					<td><c:out value='${item.sortNumber}' />&nbsp;</td>
				</tr>
				</c:forEach>
				</table>
			</form>
