...
<html>
	...
	<body>
		<div class="main">
			<form id="dataform" name="dataform" action="${ctx}/organiz/Organization!save.do" method="post">
				<div class="maintit">
					<h2><img src="${ctx}/${pattern}/images/tabicon.gif" width="16" height="16" align="absmiddle" />新增单位</h2>
