...
<div class="op_box_cen" style="width: 100%; overflow: hidden; height: 334px;">
	...
	<div style="clear:both;font-size:0px;height:0px;overflow:hidden;">
		<form method="post" action="${ctx }/organiz/User!listForStation.do" id="grantUserForm">
	...
	<div class="iframe_box" style="padding: 0px 0px 0px 0px; width: 100%" >
		<iframe src="${pageContext.request.contextPath }/organiz/User!loadUserList.do"  style="border:none;" frameborder="0" width="100%" height="206" scrolling="auto">
		</iframe>
	</div>
