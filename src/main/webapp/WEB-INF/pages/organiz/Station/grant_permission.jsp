...
<rapid:override name="head">
	...
	$(function() {
		...
		tree.setXMLAutoLoading("${ctx}/organiz/Station!toGrantPage.do?id=${id}");
		tree.loadXML("${ctx}/organiz/Station!toGrantPage.do?id=${id}&partitionId=${partitionId}");
	});
	// 递归处理子节点
...
<body class="mainbody">
<form action="${ctx}/organiz/Station!grantPermission.do" id="perForm" name="perForm" method="post" >
