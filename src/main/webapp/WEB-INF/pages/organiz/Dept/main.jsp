...
<div class="main-leftit"><img src="${ctx }/images/main_ico18.gif" width="15" height="15" align="absmiddle" /> 单位部门</div>
<div class="main-lefmenu" style="height: 87%;">
<iframe name="leftFrame" width="100%" height="100%" src="${ctx}/organiz/Dept!leftTree.do" frameborder="0" scrolling="no" ></iframe>
</div>
</div>
...
<iframe style="padding-left: 0px;" name="rightFrame" width="100%" height="100%" src="${ctx}/organiz/Dept!toRightPage.do?query.organizationId=${orgId}" frameborder="0" scrolling="no"></iframe>
</div>
</div>
