...
<head>
	...
	$(function() {
		...
		tree.setXMLAutoLoading("${ctx}/organiz/Dept!deptXML.do");
		tree.loadXML("${ctx}/organiz/Dept!deptXML.do");
	...
	function openPathDocs(id) {
		...
		//如果节点id等于当前单位id
		if('${orgId}'==id){
			window.parent.rightFrame.location.href = "${ctx}/organiz/Dept!toRightPage.do?query.organizationId=${orgId}";
		}else{
			window.parent.rightFrame.location.href = "${ctx}/organiz/Dept!toRightPage.do?query.organizationId=${orgId}&query.parentId=" + id;
		}
