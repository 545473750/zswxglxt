	...
	<body>
		<div class="main">
			<div class="maintit">
				...
				<!-- 
				<h2>
					<a href="${ctx}/organiz/Unit!loadUser.do?parentid=${pid }&partitionId=${partitionId}&parentOrganizationType=${organizationModel.type}" style="text-decoration: none;"> 
					<img src="${ctx}/${pattern}/images/tabicon.gif" width="16" height="16" align="absmiddle" /> 单位人员 
					</a>
				</h2>
				 -->
			...
			<div class="centent">
				<div class="search">
					<form id="queryForm" name="queryForm" method="post" action="${ctx}/organiz/Unit!list.do">
						<label>
							单位名称：
			...
			<form id="listForm" name="listForm" method="post" >
				...
				<div class="page">
					<jsp:include flush="true" page="/commons/pagebar.jsp">
						<jsp:param name="target" value="/organiz/Unit!list.do" />
					</jsp:include>
				</div>
			</div>
