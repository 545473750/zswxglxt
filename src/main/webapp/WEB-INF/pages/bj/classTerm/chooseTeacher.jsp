...
<script type="text/javascript">
	...
	function submitValue() {
		//设置教师id和教师name
		var param = document.getElementById("teacher").value;
		var id = document.getElementById("ids").value;
		var name = document.getElementById("names").value;
		parent.mainFrame.window.setTeacherName(param,name,id);
	...
	function resetValue() {
		...
		document.getElementById('userList').innerHTML = "<div class='iframe_name_box'><p class='iframe_name_text'><b>已选教师</b></p></div>";
...
<div class="llistbox" style="float: left; width:150px; height: 470px; margin-left: 5px;margin-top: 5px;overflow:auto; align:center" >
	<div id="userList" style="padding-left: 2px;">
		<div class='iframe_name_box'><p class='iframe_name_text'><b>已选教师</b></p></div>
		${selectedOrgHTML }
		
	</div>
	<div style="clear:both;font-size:0px;height:0px;overflow:hidden;"></div>
</div>
<div style="width: 530px;float: left;margin-top:5px;" class="llistbox">
	<iframe src="${ctx}/bj/ClassTerm!seachUser.do" height="470" width="100%"  frameborder="0"  scrolling="auto">
	</iframe>
</div>
