...
<body>
   ...
   <div class="search" style="margin: 0px; height: 30px;">
       <form id="queryForm" name="queryForm" method="post" action="${ctx}/bj/ClassRecruit!findSchool.do">
    		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="32" >学校名称：</td>		
				<td>
					<input value="${orgQuery.name}" id="name" name="orgQuery.name" maxlength="100"  class=""/>
				</td>
				<td>
           ...
           <td width="70%">
            <div class="pages">
				<jsp:include flush="true" page="/commons/pagebar.jsp">
					<jsp:param name="target" value="/bj/ClassRecruit!findSchool.do" />
		        </jsp:include>
        	</div>
           </td>
        </tr>
