...
<script src="${ctx}/scripts/dhtmlxtree.js"></script>
	...
	$(function() {
		...
		tree.setXMLAutoLoading("${ctx}/application/Permission!permissionXML.do?applicationId=${applicationId}");
		tree.loadXML("${ctx}/application/Permission!permissionXML.do?applicationId=${applicationId}");
	...
	function openPathDocs(id) {
		window.parent.mainFrame.location.href = "${ctx}/application/Permission!list.do?query.parentId=" + id+"&query.applicationId=${applicationId}";
	}
	</script>
