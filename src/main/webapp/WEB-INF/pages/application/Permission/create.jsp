...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		function goBack(){
			document.getElementById("dataform").action="Permission!list.do";
	...
	<body>
			<div class="main">
				...
				<div class="centent" style="padding-top: 10px;">
					...
					<form id="dataform" name="dataform" action="${ctx}/application/Permission!save.do"
					method="post">
						...
						<input type="button" value="取 消" class="but_shop" onclick="window.history.go(-1)" />
						</div>
