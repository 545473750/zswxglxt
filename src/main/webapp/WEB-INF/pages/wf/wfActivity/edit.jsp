...
<div class="main">
	<div class="maintit">
		<h2><img src="${ctx}/${pattern}/images/tabicon.gif" width="16" height="16" align="absmiddle"/>修改流程节点</h2>
	...
	<form id="dataform" action="${ctx}/wf/WfActivity!saveEdit.do" method="post">
		<span>
